/*
This moves the robot to the foundation and moves it out of the buildzone if the robot is on the right side of the field and on the same side as the foundation
Test and edit
TURN_TIME variable
...
@Autonomous (name = "Move Foundation")
...
public class MoveFoundation extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        driveMethod(-1,-1,FOUNDATION_TIME);
        strafeLeft(RIGHT_SECONDS + REMAINING_TIME);
